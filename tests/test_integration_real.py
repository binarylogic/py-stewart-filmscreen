...
@pytest.mark.asyncio
async def test_real_device_startup_auth(real_client: StewartFilmscreenClient) -> None:
    assert real_client.connected is True


@pytest.mark.integration_real
@pytest.mark.asyncio
async def test_real_device_read_only_query(real_client: StewartFilmscreenClient) -> None:
